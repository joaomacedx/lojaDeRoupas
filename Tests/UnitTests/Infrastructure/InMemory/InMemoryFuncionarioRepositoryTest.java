...
public class InMemoryFuncionarioRepositoryTest {
    ...
    @Test(expected = Error.class)
    public void findById_com_erro_QUANDO_argumentos_passados_sao_invalidos_ENTAO_retorna_um_Error() {
        //Arrange
    ...
    @Test(expected = Error.class)
    public void Delete_com_erro_QUANDO_funcionario_passado_nao_esta_cadastrado__ENTAO_retorna_um_Error() {
        //Arrange
    ...
    @Test
    public void Delete_com_sucesso_QUANDO_funcionario_passado_esta_cadastrado__ENTAO_remove_funcionario_da_lista() {
        //Arrange
